...
// ⚡ Bolt Optimization: We use dynamic imports (`await import(...)`) for all command handlers.
// This lazy-loads the heavy dependencies (like express, adm-zip, axios) only when the command is actually run.
// This reduces the cold-start time of the CLI (e.g., when running `pandya --help`) by over 60%!
